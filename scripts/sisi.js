const sisi = (function () {
    ...
    function createNonogram(settings) {
            ...
            if (numSectionLines === 0) { 
                ...
                if (match) {
                    ...
                    if (curSection === 'size') {
                        ...
                        numSectionLines = numRows;
                    } else if (curSection === 'columns') {
                        numSectionLines  = numCols;
                    }
                    continue;
                }
                ...
                if (curSection === 'size') {
                    [numRows, numCols] = line.split(' ').map(el => parseInt(el.trim()));
                } else if (curSection  === 'rows') {
                    rowBlocks.push(line.split(' ').map(el => parseInt(el.trim())));
                } else if (curSection  === 'columns') {
                    colBlocks.push(line.split(' ').map(el => parseInt(el.trim())));
                }
        ...
        const result = new Nonogram(numRows, numCols);
